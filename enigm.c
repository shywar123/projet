...
**/
/**
* @brief to generate the question .
...
/**
* @brief To initialize the question .
* @param  n
* @param url the url of the image
* @return Nothing
*/
...
//Initialisation de SDL_TTF 
 ...
 font = TTF_OpenFont( "caslon.ttf", 40 ); 
