...
void initialiser_backgroundm(background *bckgm1 , background *bckgm2){
	...
	bckgm1->calque_background=IMG_Load("128.png");

	bckgm1->afficher_background=NULL;
	bckgm1->afficher_background=IMG_Load("128.png");
	...
	bckgm2->calque_background=IMG_Load("128.png");

	bckgm2->afficher_background=NULL;
	bckgm2->afficher_background=IMG_Load("128.png");
	bckgm2->pos_background.x=600;
...
void afficher_evanm(hero evan1,hero evan2,SDL_Surface *ecran){
	if ((evan1.mouvment==1)||(evan1.mouvment==9)||!(evan2.mouvment==2))
